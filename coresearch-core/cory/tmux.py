"""tmux helpers for cory sessions.

Mirrors runner/core/tmux.py but kept as a tiny separate copy so the cory
container does not need to depend on the runner package. The two implementations
...
def create_tmux_session(name: str, working_dir: str | None = None) -> str:
